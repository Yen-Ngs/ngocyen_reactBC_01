        ...
        return <div key="{index}" className="col-4 mt-2">
            <div className="card text-white bg-dark border-none">
                ...
                <div className="card-body">
                    <h4 className="card-title" style={{height:80}}>{phim.tenPhim >50 ? <p>{phim.tenPhim.substr(0,50)}...</p>:<p>{phim.tenPhim}</p>}</h4>
                    <div className="card-text">{phim.moTa >100 ? <p>{phim.moTa.substr(0,100)}...</p>:<p>{phim.moTa}</p>}</div>
                </div>
            </div>
        </div>
        </div>
